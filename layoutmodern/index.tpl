...
<div id="LoginstatusText_2_2" class="LoginstatusText" style="background-image:url({$path}/templates/tibia/images/global/loginbox/loginbox-font-create-account-over.gif)" ></div></div>     </div>      <div id="BorderRight" class="LoginBorder" style="background-image:url({$path}/templates/tibia/images/global/general/chain.gif)" ></div>
     <div id="LoginBottom" class="Loginstatus" style="background-image:url({$path}/templates/tibia/images/global/general/box-bottom.gif)" ></div>   </div> 
{/if}
...
<script type='text/javascript'>InitializePage();</script>        </div>         <div id="ContentColumn">           <div id="Content" class="Content">             <div id="ContentHelper"><script type="text/javascript" src="{$path}/templates/tibia/javascripts/newsticker.js"></script>     <div id="newsticker" class="Box">     <div class="Corner-tl" style="background-image:url({$path}/templates/tibia/images/global/content/corner-tl.gif);"></div>     <div class="Corner-tr" style="background-image:url({$path}/templates/tibia/images/global/content/corner-tr.gif);"></div>     <div class="Border_1" style="background-image:url({$path}/templates/tibia/images/global/content/border-1.gif);"></div>     <div class="BorderTitleText" style="background-image:url({$path}/templates/tibia/images/global/content/title-background-green.gif);"></div>     <img id="ContentBoxHeadline" class="Title" src="{$path}/templates/tibia/images/global/strings/headline-newsticker.gif" alt="Contentbox headline" />     <div class="Border_2">       <div class="Border_3"> 

{include_php file="templates/tibia/newstickers.php"}




        </div></div>    <div class="Border_1" style="background-image:url({$path}/templates/tibia/images/global/content/border-1.gif);"></div>     <div class="CornerWrapper-b"><div class="Corner-bl" style="background-image:url({$path}/templates/tibia/images/global/content/corner-bl.gif);"></div></div>     <div class="CornerWrapper-b"><div class="Corner-br" style="background-image:url({$path}/templates/tibia/images/global/content/corner-br.gif);"></div></div>   </div>    <div id="featuredarticle" class="Box">     <div class="Corner-tl" style="background-image:url({$path}/templates/tibia/images/global/content/corner-tl.gif);"></div>     <div class="Corner-tr" style="background-image:url({$path}/templates/tibia/images/global/content/corner-tr.gif);"></div>     <div class="Border_1" style="background-image:url({$path}/templates/tibia/images/global/content/border-1.gif);"></div>     <div class="BorderTitleText" style="background-image:url({$path}/templates/tibia/images/global/content/title-background-green.gif);"></div>     <img id="ContentBoxHeadline" class="Title" src="{$path}/templates/tibia/images/global/strings/headline-featuredarticle.gif" alt="Contentbox headline" />     <div class="Border_2">       <div class="Border_3">
         <div class="BoxContent" style="background-image:url({$path}/templates/tibia/images/global/content/scroll.gif);"> 

{include_php file="templates/tibia/featuredarticle.php"}

       </div>       </div>     </div>     <div class="Border_1" style="background-image:url({$path}/templates/tibia/images/global/content/border-1.gif);"></div>     <div class="CornerWrapper-b"><div class="Corner-bl" style="background-image:url({$path}/templates/tibia/images/global/content/corner-bl.gif);"></div></div>     <div class="CornerWrapper-b"><div class="Corner-br" style="background-image:url({$path}/templates/tibia/images/global/content/corner-br.gif);"></div></div>   </div>    <div id="news" class="Box">     <div class="Corner-tl" style="background-image:url({$path}/templates/tibia/images/global/content/corner-tl.gif);"></div>     <div class="Corner-tr" style="background-image:url({$path}/templates/tibia/images/global/content/corner-tr.gif);"></div>     <div class="Border_1" style="background-image:url({$path}/templates/tibia/images/global/content/border-1.gif);"></div>     <div class="BorderTitleText" style="background-image:url({$path}/templates/tibia/images/global/content/title-background-green.gif);"></div>     <img id="ContentBoxHeadline" class="Title" src="{$path}/templates/tibia/images/global/strings/headline-news.gif" alt="Contentbox headline" />     <div class="Border_2">       <div class="Border_3">         <div class="BoxContent" style="background-image:url({$path}/templates/tibia/images/global/content/scroll.gif);">
   {$main}      
...
{$serverPlayers[$id]}		<br />Players Online							{else}
      ...
      <div id="ScreenshotBox" class="Themebox" style="background-image:url({$path}/templates/tibia/images/global/themeboxes/screenshot/screenshotbox.gif);">
      <a href="{$path}/index.php/p/v/gallery">
        <img id="ScreenshotContent" class="ThemeboxContent" src="{$path}/templates/tibia/images/abouttibia/screenshotoftheday.png" alt="Screenshot of the Day">
      </a>
    <div class="Bottom" style="background-image:url(http://static.tibia.com/images/global/general/box-bottom.gif);"></div>
    </div>

      <div id="CurrentPollBox" class="Themebox" style="background-image:url({$path}/templates/tibia/images/global/themeboxes/current-poll/currentpollbox.gif);">       <div id="CurrentPollText">Most powerful vocation?</div>       <a class="ThemeboxButton" href="{$path}" onMouseOver="MouseOverBigButton(this);" onMouseOut="MouseOutBigButton(this);" style="background-image:url({$path}/templates/tibia/images/global/buttons/sbutton.gif);"><div class="BigButtonOver" style="background-image:url({$path}/templates/tibia/images/global/buttons/sbutton_over.gif);"></div>         <div class="ButtonText" style="background-image:url({$path}/templates/tibia/images/global/buttons/_sbutton_votenow.gif);"></div>       </a>       <div class="Bottom" style="background-image:url({$path}/templates/tibia/images/global/general/box-bottom.gif);"></div>     </div>
